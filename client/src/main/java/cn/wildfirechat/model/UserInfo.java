...
public class UserInfo implements Parcelable, Comparable<UserInfo> {
    ...
    public int hasTradePwd; // 1 = 已设定密码
    public boolean createGroupEnable;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(hasTradePwd);
        dest.writeInt(createGroupEnable ? 1 : 0);
    }
    ...
    protected UserInfo(Parcel in) {
        ...
        this.hasTradePwd = in.readInt();
        this.createGroupEnable = in.readInt() == 1;
    }
