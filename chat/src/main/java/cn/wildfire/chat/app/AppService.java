...
public class AppService implements AppServiceProvider {
     ...
     * <br>
     */
    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = Security.decrypt(cn.wildfire.chat.kit.BuildConfig.API_HOST);
//    public static String APP_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "https://app.wildfirechat.net";
    ...
    public void setAppServerAddress(String appServerAddress) {
        APP_SERVER_ADDRESS = appServerAddress;
    }
    ...
    public void passwordLogin(String mobile, String password, LoginCallback callback) {
        ...
        params.put("password", Security.getSha256(password));
    ...
    public void smsLogin(String inviteCode, String phoneNumber, String authCode, LoginCallback callback) {
    ...
    public void resetPassword(String mobile, String code, String password, SimpleCallback<StatusResult> callback) {
        ...
        params.put("newPassword", Security.getSha256(password));
    ...
    public void changePassword(String oldPassword, String newPassword, SimpleCallback<StatusResult> callback) {
        ...
        Map<String, Object> params = new HashMap<>();
        params.put("oldPassword", Security.getSha256(oldPassword));
        params.put("newPassword", Security.getSha256(newPassword));
    ...
    public void getUserInfo(String userId, SimpleCallback<Void> callback) {
    ...
    public void removeFavoriteItem(int favId, SimpleCallback<Void> callback) {
        ...
        OKHttpHelper.post(url, new HashMap<>(), callback);
    }
    ...
    public LiveData<WebResponse<String>> getServiceUrl() {
        MutableLiveData<WebResponse<String>> liveData = new MutableLiveData<>();
        ImplementUserSource.Instance().getService(new SimpleCallback<String>() {
            @Override
            public void onUiSuccess(String s) {
                WebResponse<String> webResponse = WebResponse.createSuccess();
                webResponse.result = s;
                liveData.postValue(webResponse);
            }

            @Override
            public void onUiFailure(int code, String msg) {
                WebResponse<String> webResponse = new WebResponse<>(code, msg);
                liveData.postValue(webResponse);
            }
        });
        return liveData;
     ...
     * @return
     */
    public void getImageServiceHost(SimpleCallback<String> callback) {
        ImplementUserSource.Instance().getImagePathDomain(callback);
    }
}
