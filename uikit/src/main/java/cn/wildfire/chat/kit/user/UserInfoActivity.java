...
//    android:id="@+id/setAlias"
            ...
            contactViewModel.deleteFriend(userInfo.uid).observe(
                    this, booleanOperateResult -> {
                        if (booleanOperateResult.isSuccess()) {
                            deleteConversation(userInfo.uid);
    ...
    private void deleteConversation(String targetId) {
        conversationViewModel.clearMessages(Conversation.ConversationType.Single.getValue(), targetId, 0);
    }
}
