...
public class MultiCallParticipantAdapter extends RecyclerView.Adapter<MultiCallParticipantAdapter.ParticipantViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ParticipantViewHolder holder, int position) {
        ...
        GlideUtil.load(imageView, userInfo.portrait).into(imageView);
