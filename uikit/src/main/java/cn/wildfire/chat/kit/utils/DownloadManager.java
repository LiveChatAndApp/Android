...
public class DownloadManager {
    ...
    public static void download(final String checkUrl, final String saveDir, String name, final OnDownloadListener listener) {
        String url = GlideUtil.checkHost(checkUrl);
        LogHelper.e("download", "checkUrl = " + checkUrl);
        LogHelper.e("download", "url = " + url);
        LogHelper.e("download", "saveDir = " + saveDir);
        LogHelper.e("download", "name = " + name);
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (!file.exists()) {
                        ...
                        LogHelper.e("download", "createNewFile = " + isSuccess);
                    }
