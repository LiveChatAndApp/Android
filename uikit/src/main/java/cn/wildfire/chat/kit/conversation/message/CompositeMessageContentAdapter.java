    ...
    static class MessageContentViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Message message, int position) {
            ...
            if (position == 0) {
                ...
                GlideUtil.load(itemView, userInfo.portrait)
            ...
            if (content instanceof ImageMessageContent) {
                ...
                GlideUtil.load(itemView, imageMessageContent.remoteUrl)
                ...
                GlideUtil.load(itemView, videoMessageContent.getThumbnail())
