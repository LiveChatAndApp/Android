...
public class Config {
     ...
     * <br>
     */
    public static String IM_SERVER_HOST /*请仔细阅读上面的注释*/ = Security.decrypt(BuildConfig.IM_SERVER_HOST);
    ...
    public static String[][] ICE_SERVERS/*请仔细阅读上面的注释*/ = new String[][]{
            ...
            {"turn:61.220.44.217:3478", "jyint", "123456"}
    };
    ...
    public static final String SP_INIT_FILE_NAME = "appInit";
