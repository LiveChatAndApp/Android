...
//                                        }
     ...
     *
     */
    public void clearMessages(int type, String targetId, int line) {
        ConversationInfo conversationInfo = ChatManager.Instance().getConversation(type, targetId, line);
        ChatManager.Instance().clearMessages(conversationInfo.conversation);
        if (clearConversationMessageLiveData != null) {
            clearConversationMessageLiveData.setValue(conversationInfo.conversation);
        }
    }
